...
public record EvaluationExternalPersonalRequestDto(
    ...
    @JsonProperty("answers") @NotNull List<EvaluationExternalPersonalAnswerRequestDto> answers,
    @JsonProperty("file_paths") List<String> filePaths) {
  public EvaluationExternalPersonalRequestDto(
      Long userId,
      ...
      List<EvaluationExternalPersonalAnswerRequestDto> answers,
